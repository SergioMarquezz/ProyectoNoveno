            ...
            <form action="" >
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="md-form">
                            <input type="number" id="form1" class="form-control" disabled>
                ...
                <div class="row">
                    <div class="col-lg-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="md-form">
                            <input type="text" id="form2" class="form-control" disabled>
                            <label for="form1">Nombre</label>
                        </div>
                    </div>
                    <div class="col-lg-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="md-form">
                            <input type="number" id="form" class="form-control" disabled>
