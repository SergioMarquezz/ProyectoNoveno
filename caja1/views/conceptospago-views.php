...
<body>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="md-form">
                                ...
                                <label for="form1">Clave Concepto</label>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-4">
                            <button class="btn btn-success" id="selecion-concepto" data-toggle="modal" data-target="#modal1">Concepto de pago</button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="md-form">
                                ...
                                <label for="form1">Descripción</label>
                            </div>
                        </div>
                        <div class="col-lg-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="md-form">
                                <input type="number" id="form" class="form-control">
                                <label for="form1">Costo Unitario</label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
    ...
    <h4 class="text-white text-center mt-3">Conceptos De Pago</h4>
            <div class="modal-content modal-dialog cascading-modal modal-avatar">
                <div class="modal-header">
                    <img src="<?php echo SERVER;?>views/img/logoHalcon.jpg" alt="avatar" class="rounded-circle img-responsive">
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="md-form">
                        ...
                        <label for="clave-concepto" class="text-white">Clave</label>
                    </div>
                </div>
                <div class="col-lg-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="md-form">
                        <input type="number" disabled id="costo-concepto" class="form-control">
                        <label for="costo-concepto" class="text-white">Consto Unitario</label>
                    </div>
                </div>
                <div class="col-lg-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="md-form">
