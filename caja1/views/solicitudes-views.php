    ...
    <div class="container">
        <div class="card">
            <div class="card-header text-white" style="background: #024a86;">
                <i class="zmdi zmdi-plus"></i> &nbsp; NUEVA TRÁMITE O SERVICIO
            </div>
            <div class="card-body">
                ...
                <form action="" data-form="save" method="" class="FormularioSolicitud" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="cve_concepto" type="hidden" id="clave_concepto" class="form-control text-dark" disabled>
                                <div class="form-group">
                    ...
                    <div class="container row justify-content-center mt-5">
                        <div class="col-md-12 mb-12" id="buttons">
                            ...
                            <button id="guardarSolicitud" type="button" class="btn btn-block"><i class=""></i>Generar Referencia</button>
                        </div>
                    </div>
                               ...
                               <div class="row">
                                    <div class="col-xl-12">
                                        <div class="form-group mt-3">
                                            ...
                                            <input name="name-completo" type="text" id="nombre-completo" class="form-control text-dark" disabled>
                                        </div>
                                    </div>
                               </div>
                               <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-group mt-3">
                                            ...
                                            <input name="num-control" type="text" id="numero-control" class="form-control text-dark" disabled>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="form-group mt-3">
                                            <label for="convenio" class="label-solicitud">Convenio CIE</label>
                                            <input value="001364332" name="convenio" type="text" id="cie" class="form-control text-dark" disabled>
                                        </div>
                                    </div>
                               </div>
                               <div class="row">
                                    <div class="col-xl-12">
                                        <div class="form-group mt-3">
                                            ...
                                            <input name="carrera" type="text" id="carrer" class="form-control text-dark" disabled>
                                        </div>
                                    </div>
                               </div>
                               <div class="row">
                                    <div class="col-xl-12">
                                        <div class="form-group mt-3">
                                            ...
                                            <input name="concepto" type="text" id="descripcion" class="form-control text-dark" disabled>
                                        </div>
                                    </div>
                               </div>
                               <div class="row">
                                    <div class="col-xl-4">
                                        <div class="form-group mt-3">
                                            ...
                                            <input name="referencia" type="text" id="bancaria" class="form-control text-dark" disabled>
                                        </div>
                                    </div>
                                    <div class="col-xl-4">
                                        <div class="form-group mt-3">
                                            <label for="valida" class="label-solicitud">Válido hasta</label>
                                            <input name="valida" type="text" id="validez" class="form-control text-dark" disabled>
                                        </div>
                                    </div>
                                    <div class="col-xl-4">
                                        <div class="form-group mt-3">
                                            <label for="cantidad" class="label-solicitud">Cantidad a pagar</label>
                                            <input name="cantidad" type="text" id="monto" class="form-control text-dark" disabled>
                                        </div>
                                    </div>
                               </div>
                               <div class="row">
                                    <div class="col-xl-12">
                                        <button id="imprimir-referencia" class="float-right btn" type="button"><i class="fa fa-file-pdf-o pr-2"></i>Imprimir Referencia</button>
                                    </div>
                               </div>
                            </form>
                        </div>
