...
?>
 ...
 <head>
     ...
     <title><?php echo ACRONYM;?> | REINSCRIPCIÓN</title>
 ...
 <div class="container title-container">
    <div class="page-header">
        <h4 class="text-titles mt-4"><i class="zmdi zmdi-bookmark"></i> Reinscripción</h4>
    </div>
</div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                        <div class="md-form">
                            ...
                            <label for="promedio-final">Promedio Final</label>
                        </div>
                    </div>
                </div>
            </div>
