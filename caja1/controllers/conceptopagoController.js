...
function deleteConcept(){
    ...
    $("#eliminar").click(function (e) { 
        ...
        var tipo = attr[1].nodeValue = "delete";

        if(tipo==="delete"){
            textoAlerta="El concepto sera borrado del sistema, estas seguro de continuar";
        }
        ...
        swal({
            ...
            $.ajax({
                ...
                success: function (response) {
                   ...
                   if(json.respuesta == "borrado"){

                        swal({
                            title: "Eliminación Correcta",   
                            text: "El concepto fue borrado de manera satisfactoria",   
                            type: "success",     
                            confirmButtonText: "Aceptar",
                            allowOutsideClick: false
                        }).then(function (){
