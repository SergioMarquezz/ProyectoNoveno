...
class PDF extends FPDF
{
	...
	{
		// Logo
		$this->Image('../img/constanciaA.png',3,10,205);
...
$pdf->Cell(0,5,"CONSTANCIA DE ESTUDIOS",0,0,'R');
$pdf->Image('../../sies/fotos/'.$matricula.'.jpg',20,45,30);
$pdf->Ln(10);
//$pdf->SetFont('Arial','B',13);
...
$pdf->Image("https://chart.googleapis.com/chart?chs=250x250&cht=qr&chl=$link_qr",170,210,30,30,'PNG');
